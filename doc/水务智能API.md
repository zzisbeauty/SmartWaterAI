...
3. 
    ...
    ```json
    {"resultTo":"system","resultType":1,"textResult":{"speechText":"```json\n{ \n      \"api_id\": \"YYSF-0003\",\n      \"param1\": \"location\",\n}\n```","text":"```json\n{ \n      \"api_id\": \"YYSF-0003\",\n      \"param1\": \"location\",\n}\n```"}}
    ```

3. 用户询问的是水务场景的问题

    `给我介绍一下水务的发展情况,100字左右`

    model response json 如下：

    ```json
    {"resultTo":"system","resultType":1,"textResult":{"speechText":"随着智慧城市建设的推进，水务系统正朝着数字化、智能化、可视化方向发展。通过实时监测水源地、水库、河流等水量水质情况，分析水资源供需平衡，辅助制定调度方案。同时，供排水一体化监管和重要节点的安全设施也在不断完善。未来，水务将全面实现数字化转型，打通数据孤岛，深化智能应用，并推动绿色低碳发展。","text":"随着智慧城市建设的推进，水务系统正朝着数字化、智能化、可视化方向发展。通过实时监测水源地、水库、河流等水量水质情况，分析水资源供需平衡，辅助制定调度方案。同时，供排水一体化监管和重要节点的安全设施也在不断完善。未来，水务将全面实现数字化转型，打通数据孤岛，深化智能应用，并推动绿色低碳发展。"}}
    ```
