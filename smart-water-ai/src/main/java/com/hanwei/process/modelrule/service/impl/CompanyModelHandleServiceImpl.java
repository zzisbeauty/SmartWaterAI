...
//            }
//
//            log.info("=== 跳过真实接口调用，使用模拟数据 ===");
//
//            // 模拟外部接口的响应数据
//            String mockResponseText = "这是一个模拟的智能水务系统介绍：\n" +
//                    "智能水务系统是基于物联网、大数据、云计算等技术的现代化水务管理平台。\n" +
//                    "主要功能包括：\n" +
//                    "1. 实时监测水质、水压、流量等关键指标\n" +
//                    "2. 智能预警和故障诊断\n" +
//                    "3. 用水数据分析和优化建议\n" +
//                    "4. 移动端便民服务\n" +
//                    "当前处理的消息是：" + cleanMessage;
//
//            // 构建返回结果
...
//            textResult.setText(mockResponseText);
//            textResult.setSpeechText(mockResponseText);
//            resultForFrontVo.setTextResult(textResult);
//
//            log.info("=== 模拟响应构建完成 ===");
//            log.info("模拟响应内容: {}", mockResponseText);
//
//        } catch (Exception e) {
//            log.error("=== 测试模式异常 ===", e);
//            resultForFrontVo.setResultTo(CommonConstant.RESULT_TO_SYSTEM);
//            resultForFrontVo.setResultType(CommonConstant.RESULT_TYPE_TEXT);
//            TextResult textResult = new TextResult();
//            textResult.setText("测试模式异常: " + e.getMessage());
//            resultForFrontVo.setTextResult(textResult);
//        }
//
//        log.info("=== 测试模式处理完成 ===");
//        log.info("返回结果类型: {}", resultForFrontVo.getResultType());
//        log.info("返回结果内容: {}", resultForFrontVo.getTextResult() != null ? resultForFrontVo.getTextResult().getText() : "null");
//
